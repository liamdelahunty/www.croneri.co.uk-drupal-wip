javascript: (function() {
	...
	var divc = "</div>";
	var tao = "<textarea class='form-control mb-5' rows='12'>";
	var tac = "</textarea>";
	var h1 = document.getElementsByTagName('h1')[0].innerText.trim();
	var intro = document.getElementsByClassName('well standfirst')[0].innerText;
    ...
    square_output_02 = '<div class="row mb-3 mb-lg-5">';
    square_output_04 = '<div class="col-2 d-none d-lg-block"><a href="'+url+'" target="_blank"><img src="'+square+'" class="img-fluid"></a></div>';
    square_output_06 = '<div class="col" style="text-align: left !important;">';
    square_output_08 = '<h4><a href="'+url+'" target="_blank">'+h1+'</a></h4>';
    square_output_10 = '<p class="resettxt">'+intro+'</p>';
    square_output_12 = '</div>';
    square_output_14 = '</div>';
    threecol_output_02 = '<div class="row mb-3 mb-lg-5">';
    threecol_output_04 = '<div class="col-2 d-none d-lg-block"><a href="'+url+'" target="_blank"><img src="'+threecol+'" class="img-fluid"></a></div>';
    threecol_output_06 = '<div class="col" style="text-align: left !important;">';
    threecol_output_08 = '<h4><a href="'+url+'" target="_blank">'+h1+'</a></h4>';
    ...
    str += "<div class='row'><div class='col'>";
    str += "<h2>Threecol:</h2><p>" + threecol + "</p>\n";
    str += divc;
    str += divc;
    str += "<div class='row'><div class='col'>";
    ...
    str += divc;
    str += "<div class='col'>";
    str += threecol_output_02 + threecol_output_04 + threecol_output_06 + threecol_output_08 + threecol_output_10 + threecol_output_12 + threecol_output_14 + divc + divc;
    str += divc;
